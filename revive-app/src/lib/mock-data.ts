...
export const mockSesiones: SesionCalendario[] = [
  // Lunes
  { id: 's1', cliente_id: '2', cliente_nombre: 'Carlos', cliente_apellidos: 'Rodríguez', cliente_avatar: mockClientes[1].avatar_url, fecha: formatDate(addDays(monday, 0)), hora_inicio: '07:00', hora_fin: '08:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  { id: 's2', cliente_id: '4', cliente_nombre: 'Pedro', cliente_apellidos: 'López', cliente_avatar: mockClientes[3].avatar_url, fecha: formatDate(addDays(monday, 0)), hora_inicio: '08:30', hora_fin: '10:00', tipo: 'evaluacion', estado: 'programada', ubicacion: 'Gimnasio Central' },
  { id: 's3', cliente_id: '10', cliente_nombre: 'David', cliente_apellidos: 'Serrano', cliente_avatar: mockClientes[9].avatar_url, fecha: formatDate(addDays(monday, 0)), hora_inicio: '11:00', hora_fin: '12:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  // Martes
  { id: 's4', cliente_id: '8', cliente_nombre: 'Miguel', cliente_apellidos: 'Herrera', cliente_avatar: mockClientes[7].avatar_url, fecha: formatDate(addDays(monday, 1)), hora_inicio: '07:00', hora_fin: '08:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  ...
  // Miércoles
  { id: 's7', cliente_id: '2', cliente_nombre: 'Carlos', cliente_apellidos: 'Rodríguez', cliente_avatar: mockClientes[1].avatar_url, fecha: formatDate(addDays(monday, 2)), hora_inicio: '07:00', hora_fin: '08:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  ...
  // Jueves
  { id: 's10', cliente_id: '8', cliente_nombre: 'Miguel', cliente_apellidos: 'Herrera', cliente_avatar: mockClientes[7].avatar_url, fecha: formatDate(addDays(monday, 3)), hora_inicio: '07:00', hora_fin: '08:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  ...
  { id: 's12', cliente_id: '10', cliente_nombre: 'David', cliente_apellidos: 'Serrano', cliente_avatar: mockClientes[9].avatar_url, fecha: formatDate(addDays(monday, 3)), hora_inicio: '18:30', hora_fin: '19:30', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  // Viernes
  { id: 's13', cliente_id: '2', cliente_nombre: 'Carlos', cliente_apellidos: 'Rodríguez', cliente_avatar: mockClientes[1].avatar_url, fecha: formatDate(addDays(monday, 4)), hora_inicio: '07:00', hora_fin: '08:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  { id: 's14', cliente_id: '4', cliente_nombre: 'Pedro', cliente_apellidos: 'López', cliente_avatar: mockClientes[3].avatar_url, fecha: formatDate(addDays(monday, 4)), hora_inicio: '08:30', hora_fin: '10:00', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central' },
  ...
  // Sábado
  { id: 's17', cliente_id: '4', cliente_nombre: 'Pedro', cliente_apellidos: 'López', cliente_avatar: mockClientes[3].avatar_url, fecha: formatDate(addDays(monday, 5)), hora_inicio: '09:00', hora_fin: '10:30', tipo: 'presencial', estado: 'programada', ubicacion: 'Gimnasio Central', notas: 'Sesión extra competición' },
  { id: 's18', cliente_id: '1', cliente_nombre: 'María', cliente_apellidos: 'García', cliente_avatar: mockClientes[0].avatar_url, fecha: formatDate(addDays(monday, 5)), hora_inicio: '11:00', hora_fin: '12:00', tipo: 'evaluacion', estado: 'programada', notas: 'Evaluación mensual' },
]
